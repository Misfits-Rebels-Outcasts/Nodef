...
import SwiftUI
@available(iOS 15.0, *)
struct VortexDistortionPropertiesViewX: View, NodeProperties {

    @ObservedObject var fx: VortexDistortionFX = VortexDistortionFX()
    ...
    var body: some View {
        ...
        Section(header: Text("Options")){
            ...
            /*
            Slider(value: $fx.angle, in: 0...500 ) //default 56.55 revisit
                .onChange(of: fx.angle) { newValue in
                    applyFilter()
                }
             */
            Slider(value: $fx.angle, in: 0...500, onEditingChanged: {editing in
                applyFilter(editing)
            })
