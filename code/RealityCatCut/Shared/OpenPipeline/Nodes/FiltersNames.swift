...
class FilterNames
{
    static func GetFilterType() -> [String]
    {
        ...
        if appType == "N" {
            //return (GetMonoFilterType() + GetBlendFilterType() + GetShaderType() + GetVideoFilterType() + GetARType()).sorted()
            return (GetMonoFilterType() + GetBlendFilterType() + GetVideoFilterType() + GetARType()).sorted()
        }
    ...
    static func GetStartType() -> [String]
    {
        //let filterType = ["Read Image",
        //                  "Read Video"]
        let filterType = [
                          "Read Video"]
    ...
    static func GetVideoFilterType() -> [String]
    {
        let videoType = [
            "Read Video",
            "Join Video",
