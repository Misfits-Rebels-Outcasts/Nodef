...
import SwiftUI
@available(iOS 15.0, *)
struct OpTilePropertiesViewX: View, NodeProperties {

    @ObservedObject var fx: OpTileFX = OpTileFX()
    ...
    var body: some View {
        ...
        Section(header: Text("Options")){
            ...
            Slider(value: $fx.scale, in: 0...2*3.14, onEditingChanged: {editing in
                applyFilter(editing)
            })
            ...
            Slider(value: $fx.width, in: 1...1000, onEditingChanged: {editing in
                applyFilter(editing)
            })
