...
@available(iOS 15.0, *)
struct AccordionFoldTransitionPropertiesViewX: View {
    ...
    var body: some View {
        ...
        Section(header: Text("Options")){
            ...
            Slider(value: $fx.bottomHeight, in: 0...Float(fx.size.height), onEditingChanged: {editing in
                ...
                .onChange(of: fx.bottomHeight) { newValue in
                    //print("id",fx.id)
                    applyFilter()
                }
            //revisit
            ...
            Slider(value: $fx.numberOfFolds, in: 1...10, onEditingChanged: {editing in
                ...
                .onChange(of: fx.numberOfFolds) { newValue in
                    fx.numberOfFolds=Float(Int(fx.numberOfFolds))
                    //print("id",fx.id)
                    applyFilter()
                }
            ...
            Slider(value: $fx.foldShadowAmount, in: 0...100, onEditingChanged: {editing in
                ...
                .onChange(of: fx.foldShadowAmount) { newValue in
                    //print("id",fx.id)
                    applyFilter()
                }
        }
