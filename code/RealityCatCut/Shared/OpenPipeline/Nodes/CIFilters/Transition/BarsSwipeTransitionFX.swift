...
class BarsSwipeTransitionFX: BaseTransitionFX {
    ...
    let description = "Transitions from one image (A) to another (B) by passing a bar over the source image (A). Angle is the angle of the bars. Bar Offset is the offset of one bar with respect to another."
