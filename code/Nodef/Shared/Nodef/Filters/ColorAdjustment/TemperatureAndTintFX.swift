...
class TemperatureAndTintFX: FilterX {
    ...
    let description = "Adapts the reference white point for an image. Neutral is a vector containing the source white point defined by color temperature and tint. Target Neutral is a vector containing the desired white point defined by color temperature and tint."
