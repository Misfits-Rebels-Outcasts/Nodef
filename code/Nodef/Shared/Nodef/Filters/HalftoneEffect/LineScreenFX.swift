...
class LineScreenFX: FilterX {
    ...
    let description = "Simulates the line pattern of a halftone screen. The larger the Sharpness, the sharper the pattern. Width is the distance between lines in the pattern."
    ...
    override init()
    {
        ...
        print("inputAngle")
        if let attribute = CIFilter.lineScreen().attributes["inputAngle"] as? [String: AnyObject]
        {
        ...
        print("inputWidth")
        if let attribute = CIFilter.lineScreen().attributes["inputWidth"] as? [String: AnyObject]
        {
           let minimum = attribute[kCIAttributeSliderMin] as? Float
           let maximum = attribute[kCIAttributeSliderMax] as? Float
           let defaultValue = attribute[kCIAttributeDefault] as? Float
        ...
        if let attribute = CIFilter.lineScreen().attributes["inputSharpness"] as? [String: AnyObject]
        {
           let minimum = attribute[kCIAttributeSliderMin] as? Float
           let maximum = attribute[kCIAttributeSliderMax] as? Float
           let defaultValue = attribute[kCIAttributeDefault] as? Float
