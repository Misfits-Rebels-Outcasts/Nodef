...
import SwiftUI
class PresetsX: ObservableObject, Identifiable, Equatable{
    
    static func == (lhs: PresetsX, rhs: PresetsX) -> Bool {
    ...
    init(presetType: String) {
        ...
        else if presetType == "Mask"
        {
            ...
            filterXHolder.filter.backgroundImageAlias="0"
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Histogram Hard Light Blend Mode")
            presetsList.append(filters)
            filters.initNodeIndex()
        ...
        else if presetType == "ColorAdjust"
        {
            ...
            /*
             ...
             filterXHolder=filters.getFilterWithHolder("Exposure Adjust")
             filters.add(filterHolder: filterXHolder)
             filters.setPresetName(name: "Exposure Adjust Image")
             presetsList.append(filters)
            ...
            filterXHolder=filters.getFilterWithHolder("Gamma Adjust")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Gamma Adjust Image")
            presetsList.append(filters)
            ...
            filterXHolder=filters.getFilterWithHolder("Temperature And Tint")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Temperature And Tint Image")
            presetsList.append(filters)
            ...
            filterXHolder=filters.getFilterWithHolder("White Point Adjust")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "White Point Adjust Image")
            presetsList.append(filters)
            */
            filters=FiltersX(context)
            filters.size=defaultThumbSize
...
/*
            ...
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("Droste")
            (filterXHolder.filter as! DrosteFX).insetPointX0=Float(filters.size.width/2)
            (filterXHolder.filter as! DrosteFX).insetPointY0=Float(filters.size.height/2)

            (filterXHolder.filter as! DrosteFX).insetPointX1=Float(filters.size.width/2)
            (filterXHolder.filter as! DrosteFX).insetPointY1=Float(filters.size.height/2)
            
            (filterXHolder.filter as! DrosteFX).zoom=0.0
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Droste Image")
            presetsList.append(filters)
 */
        }
        ...
        else if presetType == "Blend"
        {
            ...
            (filterXHolder.filter as! OverlayBlendModeFX).backgroundImageAlias="0"
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Overlay Blend Mode")
            presetsList.append(filters)
            ...
            filterXHolder=filters.getFilterWithHolder("Color Monochrome")
            //(filterXHolder.filter as! ColorMonochromeFX).colorStr="red"
            //(filterXHolder.filter as! ColorMonochromeFX).color =
            //(filterXHolder.filter as! ColorMonochromeFX).getColorFromString(colorStr: "red")
            (filterXHolder.filter as! ColorMonochromeFX).colorx = Color.red
            (filterXHolder.filter as! ColorMonochromeFX).color = CIColor(color: UIColor((filterXHolder.filter as! ColorMonochromeFX).colorx))
        ...
        else if presetType == "Tiling"
        {
            ...
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("PerspectiveTile")
            (filterXHolder.filter as! PerspectiveTileFX).topLeftX=125

             (filterXHolder.filter as! PerspectiveTileFX).topLeftX=Float(filters.size.height/4.0)
            (filterXHolder.filter as! PerspectiveTileFX).topLeftY=Float(filters.size.height*3.0/4.0)
            (filterXHolder.filter as! PerspectiveTileFX).topRightX=Float(filters.size.width*3.0/4.0)
            (filterXHolder.filter as! PerspectiveTileFX).topRightY=Float(filters.size.height*3.0/4.0)
  
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Perspective Tile Image")
            presetsList.append(filters)
            ...
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("TriangleTile")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Triangle Tile Image")
            presetsList.append(filters)
            ...
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("ParallelogramTile")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Parallelogram Image")
            presetsList.append(filters)
            ...
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("FourfoldTranslatedTile")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Fourfold Translated Tile Image")
            presetsList.append(filters)
            
            filters=FiltersX(context)
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("FourfoldRotatedTile")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Fourfold Rotated Tile Image")
            presetsList.append(filters)
            ...
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("SixfoldReflectedTile")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Sixfold Reflected Tile Image")
            presetsList.append(filters)
            
            filters=FiltersX(context)
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("SixfoldRotatedTile")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Sixfold Rotated Tile Image")
            presetsList.append(filters)
            
            filters=FiltersX(context)
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=filters.getFilterWithHolder("EightfoldReflectedTile")
            filters.add(filterHolder: filterXHolder)
            filters.setPresetName(name: "Eightfold Reflected Tile Image")
            presetsList.append(filters)
             */
        ...
        else if presetType == "Geometry Blend"
        {
            ...
            (filterXHolder.filter as! SunbeamsGeneratorFX).color = CIColor(color: UIColor(Color.red))
            ...
            /* small image background somehow turns out white
             large image turns out black. other iphone image turns out white
             inconsistent behavior
            filters=FiltersX()
            filters.size=defaultThumbSize
            filters.boundsCenter=CIVector(x:filters.size.width/2.0,y:filters.size.height/2.0)
            filterXHolder=FiltersX.getFilterWithHolder("Color Controls")
            filters.add(filterHolder: filterXHolder)
            filterXHolder=FiltersX.getFilterWithHolder("Hole Distortion")
            (filterXHolder.filter as! HoleDistortionFX).radius=(filterXHolder.filter as! HoleDistortionFX).radius/compensateFactor
            filters.add(filterHolder: filterXHolder)
            filterXHolder=FiltersX.getFilterWithHolder("Source Out Compositing")
            filterXHolder.filter.inputImageAlias="1"
            filterXHolder.filter.backgroundImageAlias="2"
            filters.setPresetName(name: "Hole Source Out Compositing")
            filters.add(filterHolder: filterXHolder)
            presetsList.append(filters)
             */
        }
