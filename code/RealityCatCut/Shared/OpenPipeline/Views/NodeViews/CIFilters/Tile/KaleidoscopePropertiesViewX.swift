...
import SwiftUI
@available(iOS 15.0, *)
struct KaleidoscopePropertiesViewX: View, NodeProperties {

    @ObservedObject var fx: KaleidoscopeFX = KaleidoscopeFX()
    ...
    var body: some View {
        ...
        Section(header: Text("Options")){
            ...
            Slider(value: $fx.count, in: 1...64, onEditingChanged: {editing in
                applyFilter(editing)
            })
                .onChange(of: fx.count) { oldValue, newValue in
                    applyFilter()
                }
