...
class Convolution3X3FX: FilterX {
    ...
    @Published var w4:Float = -1.0
    @Published var w5:Float = 4.0
    @Published var w6:Float = -1.0
...
*/
    ...
    //Box blur
    /*
    @Published var w1:Float = 1/9
    @Published var w2:Float = 1/9
    @Published var w3:Float = 1/9
    @Published var w4:Float = 1/9
    @Published var w5:Float = 1/9
    @Published var w6:Float = 1/9
    @Published var w7:Float = 1/9
    @Published var w8:Float = 1/9
    @Published var w9:Float = 1/9
     */
    
    //Gaussian Blur
    /*
    @Published var w1:Float = 1/16
    @Published var w2:Float = 2/16
    @Published var w3:Float = 1/16
    @Published var w4:Float = 2/16
    @Published var w5:Float = 4/16
    @Published var w6:Float = 2/16
    @Published var w7:Float = 1/16
    @Published var w8:Float = 2/16
    @Published var w9:Float = 1/16
    */
    ...
    let description = "Modifies pixel values by performing a 3x3 matrix convolution. The default values provide a convolution matrix to sharpen the image."
