...
struct ReciprocalPropertiesViewX: View, NodeProperties {
    ...
    var body: some View {
        ...
        Section(header: Text("Options")){
            ...
            Slider(value: $fx.n1, in: 0.1...5, onEditingChanged: {editing in
                ...
                .onChange(of: fx.n1) { oldValue, newValue in
                    applyFilter()
                }
            ...
            Slider(value: $fx.exp1, in: 0.1...10, onEditingChanged: {editing in
                ...
                .onChange(of: fx.exp1) { oldValue, newValue in
                    applyFilter()
                }
            ...
            Slider(value: $fx.n2, in: 0.1...5, onEditingChanged: {editing in
                ...
                .onChange(of: fx.n2) { oldValue, newValue in
                    applyFilter()
                }
            ...
            Slider(value: $fx.exp2, in: 0.1...10, onEditingChanged: {editing in
                ...
                .onChange(of: fx.exp2) { oldValue, newValue in
                    applyFilter()
                }
