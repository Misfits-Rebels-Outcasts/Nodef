    ...
    var body: some View {
        Form{
            Group{
                ...
                {
                    Section(header: Text("Shader Effects"), footer: Text("Blend with different Shader Effects.")){
                        VStack (alignment: .leading)
                        {
                            PresetsRowViewX(presetType: "Shader Effects")
            ...
            */
            ...
            Section(header: Text("Mask"), footer: Text("Blend with a mask or a different image.")){
                    VStack (alignment: .leading)
                {
