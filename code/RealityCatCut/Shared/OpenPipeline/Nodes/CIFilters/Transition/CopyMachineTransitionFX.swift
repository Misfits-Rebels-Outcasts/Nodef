...
class CopyMachineTransitionFX: BaseTransitionFX {
    ...
    let description = "Transitions from one image (A) to another (B) by simulating the effect of a copy machine. Angle is the angle of the copier light. Color is the color of the copier light. Extent refers to a rectangle that defines the extent of the effect."
