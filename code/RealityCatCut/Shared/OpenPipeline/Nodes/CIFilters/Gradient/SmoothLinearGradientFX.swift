...
class SmoothLinearGradientFX: BaseGeneratorFX {
    ...
    override func getCIFilter(_ ciImage: CIImage) -> CIFilter {
        ...
        if smoothLinearGraidentCIFilter != nil {
            smoothLinearGraidentFilter = smoothLinearGraidentCIFilter!
        } else {
            smoothLinearGraidentFilter = CIFilter(name: type)!
            smoothLinearGraidentCIFilter=smoothLinearGraidentFilter
