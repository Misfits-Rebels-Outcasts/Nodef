...
import SwiftUI
@available(iOS 15.0, *)
struct FractalFlowNoisePropertiesViewX: View {
...
*/
                ...
                Slider(value: $fx.param_mipmaptype, in: 0...3, step:1, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.param_mipmaptype) { newValue in
                        //print("id",colorControlsFX.id)
                        //applyFilter()
                        //fx.regenerate=true
                        //parent.applyFilter()
            ...
            Group {
                ...
                Slider(value: $fx.param_direction_deg, in: -180...180, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.param_direction_deg) { newValue in
                        //print("id",colorControlsFX.id)
                        //applyFilter()
                        //fx.regenerate=true
                        //parent.applyFilter()
                ...
                Slider(value: $fx.param_expon, in: 0.2...1.6, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.param_expon) { newValue in
                        //print("id",colorControlsFX.id)
                        //applyFilter()
                        //fx.regenerate=true
                        //parent.applyFilter()
                ...
                Slider(value: $fx.param_strength, in: 0...1.0, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.param_strength) { newValue in
                        //print("id",colorControlsFX.id)
                        //applyFilter()
                        //fx.regenerate=true
                        //parent.applyFilter()
            ...
            Group {
                ...
                Slider(value: $fx.param_layerscale, in: 0.05...1.0, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.param_layerscale) { newValue in
                        //print("id",colorControlsFX.id)
                        //applyFilter()
                        //fx.regenerate=true
                        //parent.applyFilter()
                ...
                Slider(value: $fx.param_layervelocity, in: -0.5...0.5, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.param_layervelocity) { newValue in
                        //print("id",colorControlsFX.id)
                        //applyFilter()
                        //fx.regenerate=true
                        //parent.applyFilter()
                ...
                Slider(value: $fx.param_sampletype, in: 0...2.0, step:1, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.param_sampletype) { newValue in
                        //print("id",colorControlsFX.id)
                        //applyFilter()
                        //fx.regenerate=true
                        //parent.applyFilter()
