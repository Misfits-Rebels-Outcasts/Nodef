...
class StarShineGeneratorFX: BaseGeneratorFX {
    ...
    let description = "BETA NODE: Generates a starburst pattern. The output image is typically used as input to another filter. Color refers to the color to use for the outer shell of the circular star. Epsilon is the length of the cross spikes."
