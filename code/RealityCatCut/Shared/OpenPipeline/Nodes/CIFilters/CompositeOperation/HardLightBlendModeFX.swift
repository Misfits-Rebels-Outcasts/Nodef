...
class HardLightBlendModeFX: BaseBlendFX {
    ...
    let description = "Either multiplies or screens colors, depending on the source image (A) sample color. If the source image sample color is lighter than 50% gray, the background (B) is lightened, similar to screening. If the source image sample color is darker than 50% gray, the background is darkened, similar to multiplying. If the source image sample color is equal to 50% gray, the source image is not changed. Image samples that are equal to pure black or pure white result in pure black or white. The overall effect is similar to what you would achieve by shining a harsh spotlight on the source image. "
