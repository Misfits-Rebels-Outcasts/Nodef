...
class TortiseShellVoronoiFilter: CIFilter {
    ...
    override init() {
        ...
        //kernel = try! CIKernel(functionName: "tortiseShellVoronoi", fromMetalLibraryData: data)
    ...
    override var outputImage: CIImage? {
        ...
        //Jnote: remove all the rest except inputTime
