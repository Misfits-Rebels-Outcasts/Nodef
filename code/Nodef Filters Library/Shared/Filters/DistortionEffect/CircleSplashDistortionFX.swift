...
class CircleSplashDistortionFX: FilterX {
    ...
    let description = "Distorts the pixels starting at the circumference of a circle and emanating outward."
    ...
    override init()
    {
        ...
        if let attribute = CIFilter.circleSplashDistortion().attributes["inputRadius"] as? [String: AnyObject]
        {
