...
class SwipeTransitionFX: BaseTransitionFX {
    ...
    let description = "Transitions from one image to another by simulating a swiping action. Angle is the angle of the swipe. Color is the color of the swipe. Width is the width of the swipe"
