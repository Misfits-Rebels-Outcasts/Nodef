...
import SwiftUI
@available(iOS 15.0, *)
struct GaussianGradientPropertiesViewX: View, NodeProperties {


    var colors=["black","blue","clear","cyan","gray","green","magenta","red","yellow","white"]
    
    @ObservedObject var fx: GaussianGradientFX = GaussianGradientFX()
    ...
    var body: some View {
        ...
        Section(header: Text("Options")){
            ...
            */
            ...
            /*
            Slider(value: $fx.radius, in: 0...800.0 )
                .onChange(of: fx.radius) { newValue in
                    //print("id",fx.id)
                    applyFilter()
                }
             */
            Slider(value: $fx.radius, in: 0...800.0 , onEditingChanged: {editing in
                applyFilter(editing)
            })
