...
class SunbeamsGeneratorFX: BaseGeneratorFX {
    ...
    let description = "BETA NODE: Generates a sun effect. You typically use the output of the sunbeams filter as input to a composite filter. Color refers to the color of the sun. Maximum Striation Radius is the radius of the sunbeams."
