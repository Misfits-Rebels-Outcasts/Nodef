...
/*
  ...
  */
    let description = "Generates a rounded rectangle image with the specified extent, corner radius, and color."
    ...
    required init(from decoder: Decoder) throws {
        ...
        var bgcolorData = try values.decodeIfPresent(Data.self, forKey: .backgroundColor) ?? nil
        if bgcolorData != nil
        {
