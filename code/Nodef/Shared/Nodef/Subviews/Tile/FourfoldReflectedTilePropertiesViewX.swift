...
import SwiftUI
@available(iOS 15.0, *)
struct FourfoldReflectedTilePropertiesViewX: View {
    @EnvironmentObject var appSettings: AppSettings
    @ObservedObject var fx: FourfoldReflectedTileFX = FourfoldReflectedTileFX()
    ...
    var body: some View {
        ...
        Section(header: Text("Options")){
            ...
            Slider(value: $fx.acuteAngle, in: 0...2*3.14, onEditingChanged: {editing in
                ...
                .onChange(of: fx.acuteAngle) { newValue in
                    applyFilter()
                }
