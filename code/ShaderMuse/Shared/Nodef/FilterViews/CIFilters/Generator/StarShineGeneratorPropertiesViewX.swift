...
import SwiftUI
@available(iOS 15.0, *)
struct StarShineGeneratorPropertiesViewX: View {
        ...
        Section(header: Text("Options")){
            ...
            Group
            {
                ...
                Slider(value: $fx.crossScale, in: 0...100, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.crossScale) { newValue in
                        //print("id",fx.id)
                        applyFilter()
                    }
                ...
                Slider(value: $fx.crossAngle, in: 0...2*3.14, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.crossAngle) { newValue in
                        applyFilter()
                    }
                ...
                Slider(value: $fx.crossOpacity, in: -8.0...0.0, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.crossOpacity) { newValue in
                        applyFilter()
                    }
                ...
                Slider(value: $fx.crossWidth, in: 0.5...10, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.crossWidth) { newValue in
                        applyFilter()
                    }
                ...
                Slider(value: $fx.epsilon, in: -8.0...0.0, onEditingChanged: {editing in
                    ...
                    .onChange(of: fx.epsilon) { newValue in
                        applyFilter()
                    }
