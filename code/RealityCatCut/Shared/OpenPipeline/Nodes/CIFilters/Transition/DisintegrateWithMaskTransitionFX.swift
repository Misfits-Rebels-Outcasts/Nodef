...
class DisintegrateWithMaskTransitionFX: BaseTransitionMaskFX {
    ...
    let description = "Transitions from one image (A) to another (B) using the shape defined by a mask (C). Shadow Density is the density of the shadow created by the mask. Shadow Offset is the offset of the shadow created by the mask. Shadow Radisu is the radius of the shadow created by the mask."
