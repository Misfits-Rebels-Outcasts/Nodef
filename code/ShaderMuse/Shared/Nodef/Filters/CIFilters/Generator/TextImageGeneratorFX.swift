...
class TextImageGeneratorFX: BaseGeneratorFX {
    ...
    let description = "Generates an image from a string and font information."
    ...
    override func getCIFilter(currentImage: CIImage, beginImage: CIImage) -> CIFilter? {
        ...
        //affineTransformFilter.setValue(textImageGeneratorFilter.outputImage!,forKey:kCIInputImageKey)
        ...
        /*
        currentCIFilter.setValue(textImageGeneratorFilter.outputImage!,forKey:kCIInputImageKey)
        let transform=CGAffineTransform(a:1.0,b:0,c:0,d:1.0,tx:CGFloat(tx),ty:CGFloat(ty))
