  ...
  var body: some View {
    MetalViewRepresentable(metalView: $metalView)
      ...
      //  renderer = Renderer(metalView: metalView)
          ...
          let currentFilter = CIFilter(name: "CICheckerboardGenerator", parameters: ["inputColor0" : CIColor.white, "inputColor1" : CIColor.black, "inputCenter" : CIVector(x: 0, y: 0), "inputWidth" : 50.00])
