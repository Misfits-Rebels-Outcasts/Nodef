...
import SwiftUI
//ANCHISES-comeback
//After crop becomes a video, the video did not change in rendersize as of current
//may need to improve this in subsequent version s
class CropFX: FilterX {
    ...
    let description = "BETA NODE: Applies a crop to an image."
