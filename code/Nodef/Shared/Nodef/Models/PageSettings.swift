...
class PageSettings: Codable, ObservableObject, Identifiable, Equatable {
    ...
    */
    ...
    func applyPhoto(uiImage: UIImage, dpi: Double)
    {
        ...
        /*
let hRatio=UIScreen.main.bounds.size.height/(parent.pageSettings.labelHeight*parent.appSettings.dpi)
let wRatio=UIScreen.main.bounds.size.width/(parent.pageSettings.labelWidth*parent.appSettings.dpi)
...
parent.appSettings.zoomFactor=smallRatio
