...
class Convolution9VerticalFX: FilterX {
    ...
    @Published var bias:Float = 0.0
    */
    let description = "Modifies pixel values by performing a 9-element vertical convolution. The default values provide a convolution matrix to sharpen the image."
