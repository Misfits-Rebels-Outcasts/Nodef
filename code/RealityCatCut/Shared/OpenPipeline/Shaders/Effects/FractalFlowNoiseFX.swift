...
class FractalFlowNoiseFX: FilterX {
    ...
    */
    ...
    //deprecate - mask image is never used currently
    override func getCIFilter(currentImage: CIImage, beginImage: CIImage) -> CIFilter? {
        ...
        //m_flowMaskType == 4.0 only. can clean up code.
        ...
        {
            let m_initvelocityx : CGFloat = 0.5089
            let m_initvelocityy : CGFloat = 0.1501
            let m_inputAnimType: CGFloat = 0
            let m_initlocationx : CGFloat = 0.45
            let m_initlocationy : CGFloat = 0.5
            let m_accelerationx : CGFloat = -0.043
            let m_accelerationy : CGFloat =  -0.02
            let m_vscalingx :  CGFloat = 0.145256
            let m_vscalingy :  CGFloat = 0.4022
            let m_timescalingForward : CGFloat = 5.0
            let m_timescalingRemainder : CGFloat =  5.0
        ...
        {
            let m_angle = CGFloat(0)
            let m_rangeType = CGFloat(1)
            //let m_color1 = CIVector(x: 0.0, y: 0.0, z:0.0)
            //let m_color2 = CIVector(x: 0.6, y: 0.72, z: 0.4)
            
            let m_red1 = CGFloat(0.0)
            let m_green1 =  CGFloat(0.0)
            let m_blue1 =  CGFloat(0.0)
            let m_red2 = CGFloat(0.6)
            let m_green2 =  CGFloat(0.72)
            let m_blue2 =  CGFloat(0.4)
            //let m_centershift = CGFloat(0.0)
            let m_angle_2 = CGFloat(60)
            let m_centershift_2 = CGFloat(0.0)
            let m_rangeType_2 = CGFloat(1)
            let m_red1_2 = CGFloat(0.06)
            let m_green1_2 =  CGFloat(0.03)
            let m_blue1_2 =  CGFloat(0.1)
            let m_red2_2 = CGFloat(1.0)
            let m_green2_2 =  CGFloat(0.72)
            let m_blue2_2 =  CGFloat(0.8)
            let m_useSecondGrad = CGFloat(1.0)
            let m_blendweight = CGFloat(0.5)
