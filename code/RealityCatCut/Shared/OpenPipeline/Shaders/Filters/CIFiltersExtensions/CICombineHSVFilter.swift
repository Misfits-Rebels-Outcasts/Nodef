...
class CICombineHSVFilter: CIFilter {
    ...
    override init() {
        ...
        //kernel = try! CIKernel(functionName: "combineHSVFilter", fromMetalLibraryData: data)
    ...
    override var outputImage: CIImage? {
        ...
        let arguments = [inputImageR,inputImageG,inputImageB, inputTime] as [Any]
