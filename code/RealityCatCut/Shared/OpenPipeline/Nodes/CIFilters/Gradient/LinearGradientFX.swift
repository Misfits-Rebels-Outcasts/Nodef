...
class LinearGradientFX: BaseGeneratorFX {
    ...
    override func getCIFilter(_ ciImage: CIImage) -> CIFilter {
        ...
        if linearGraidentCIFilter != nil {
            linearGraidentFilter = linearGraidentCIFilter!
        } else {
            linearGraidentFilter = CIFilter(name: type)!
            linearGraidentCIFilter=linearGraidentFilter
