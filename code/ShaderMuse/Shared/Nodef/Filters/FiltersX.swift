...
class FiltersX: Codable, ObservableObject, Identifiable, Equatable{
    ...
    init(_ context: CIContext? = nil) {
        ...
        //viewerCIFilterX=CIImage(image: UIImage(named: "PhotoImage")!)
        //comeback
        /*
        let ciImage = CIImage(image: UIImage(named: "PhotoImage")!)
        viewerCIFilterX=CIFilter(name: "CIComicEffect")!
        viewerCIFilterX!.setValue(ciImage, forKey: kCIInputImageKey)
         */
    }
...
*/
    ...
    func applyFilters(image: UIImage) -> UIImage
    {
        ...
        //filteredImagePublisher=Just(viewerCIFilter.outputImage).eraseToAnyPublisher()
