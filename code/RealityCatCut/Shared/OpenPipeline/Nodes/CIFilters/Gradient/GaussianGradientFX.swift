...
class GaussianGradientFX: BaseGeneratorFX {
    ...
    override func getCIFilter(_ ciImage: CIImage) -> CIFilter {
        ...
        if gaussianGraidentCIFilter != nil {
            gaussianGraidentFilter = gaussianGraidentCIFilter!
        } else {
            gaussianGraidentFilter = CIFilter(name: type)!
            gaussianGraidentCIFilter=gaussianGraidentFilter
