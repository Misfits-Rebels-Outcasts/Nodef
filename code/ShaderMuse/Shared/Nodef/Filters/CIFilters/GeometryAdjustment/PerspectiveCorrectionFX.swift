...
class PerspectiveCorrectionFX: FilterX {
    ...
    let description = "Applies a perspective correction, transforming an arbitrary quadrilateral region in the source image to a rectangular output image."
