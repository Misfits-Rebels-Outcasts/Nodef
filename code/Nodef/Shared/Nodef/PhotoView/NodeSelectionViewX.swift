...
struct NodeSelectionViewX: View {
    ...
    init(nodeType: String, numNodes: Int = 1, filterPropertiesViewModel: FilterPropertiesViewModel) {
        self.nodeType=nodeType
        self.numNodes=numNodes
        self.filterPropertiesViewModel=filterPropertiesViewModel
        //_state = StateObject(wrappedValue: StateManager(numNodes: numNodes,filters: pageSettings.filters))
    }
    ...
    func initNodes()
    {
        state.initNodes(nodeType:nodeType, numNodes: self.numNodes, filters: pageSettings.filters, filter: self.filterPropertiesViewModel.filterXHolder.filter, filterPropertiesViewModel: self.filterPropertiesViewModel)
