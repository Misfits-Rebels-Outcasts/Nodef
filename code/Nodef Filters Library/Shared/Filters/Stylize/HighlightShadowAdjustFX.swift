...
class HighlightShadowAdjustFX: FilterX {
    ...
    let description = "Adjust the tonal mapping of an image while preserving spatial detail. Highlight Amount is the amount of adjustment to the highlights of the image. Shadown Amount is the amount of adjustment to the shadows of the image."
