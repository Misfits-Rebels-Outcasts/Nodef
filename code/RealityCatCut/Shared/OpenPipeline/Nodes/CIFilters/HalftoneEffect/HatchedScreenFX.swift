...
class HatchedScreenFX: FilterX {
    ...
    let description = "Simulates the hatched pattern of a halftone screen. Width is the distance between lines in the pattern. Sharpness refers to the amount of sharpening to apply."
    ...
    override init()
    {
        ...
        print("inputAngle")
        if let attribute = CIFilter.hatchedScreen().attributes["inputAngle"] as? [String: AnyObject]
        {
        ...
        print("inputWidth")
        if let attribute = CIFilter.hatchedScreen().attributes["inputWidth"] as? [String: AnyObject]
        {
           let minimum = attribute[kCIAttributeSliderMin] as? Float
           let maximum = attribute[kCIAttributeSliderMax] as? Float
           let defaultValue = attribute[kCIAttributeDefault] as? Float
        ...
        if let attribute = CIFilter.hatchedScreen().attributes["inputSharpness"] as? [String: AnyObject]
        {
           let minimum = attribute[kCIAttributeSliderMin] as? Float
           let maximum = attribute[kCIAttributeSliderMax] as? Float
           let defaultValue = attribute[kCIAttributeDefault] as? Float
